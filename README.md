# JuliaHealth 2026 Bounty Program
...
2. **Contributors express interest.** Interested contributors comment on a proposal, briefly explaining their relevant experience and why they are a good fit for the project.
3. **Projects are selected.** Proposals will remain open for one month. After the submission period closes, the program organizers will select six projects based on their value to JuliaHealth, scope, and feasibility.
4. **Maintainers select contributors.** The maintainers of each selected package choose the contributor they believe is best suited to complete the work.
